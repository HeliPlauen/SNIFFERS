...
def clear_steam_users():
    # TEST !!!!!!!!!!!!!!!!!!!!!!!!!
    if os.system("taskkill /f /im  Moonlight.exe") == 0:
        print("TEST Success!!!")
    else:
        print("TEST ERROR!!!")
    # TEST !!!!!!!!!!!!!!!!!!!!!!!!!
...
def off_background():
    if os.system('taskkill /f /im  "explorer.exe"') == 0:
        ...
        print("Explorer.exe is still working!!!!!!!!")
...
def computer_restart():
    ...
    if os.system("shutdown -t 0 -r -f") == 0:
        ...
        print("Computer WAS NOT rwestarted and still working!!!!!!!")


# Turn on the sniffer !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
def on_sniffing():
    current_dir = os.getcwd() 
    print(f"The current sniffer path is: {current_dir}")
    try:
        #miner_pid = subprocess.Popen(parent_dir + "\\start_eth.bat", cwd=parent_dir, creationflags=subprocess.CREATE_NEW_CONSOLE)
        subprocess.Popen("python sniffer1b.py", cwd=current_dir, creationflags=subprocess.CREATE_NEW_CONSOLE)
        print("Sniffer started successfully!!!")
    except Exception as e:
        print(f"Unable to start sniffer. Exception: {e}!!!!")
